...
const TABLES: readonly TableSpec[] = [
  ...
  { name: 'attendance', rows: attendanceRecords as unknown as Row[], key: 'id', employeeIds: ['employeeId'] },
  { name: 'regularizations', rows: regularizationRequests as unknown as Row[], key: 'id', employeeIds: ['employeeId'] },
  {
    name: 'leaveRequests',
  ...
  { name: 'payslips', rows: payslips as unknown as Row[], key: 'id', employeeIds: ['employeeId'] },
